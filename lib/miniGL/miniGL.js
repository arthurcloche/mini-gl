  ...
  getDefaultVertexShader() {
    return `#version 300 es
      ...
      void main() {
        ...
        float dynamicSize = particleSize * (1.0 + speed * 20.0); // Size increases with velocity
        
        // Apply quad offset with aspect ratio correction for circular particles
        vec2 quadOffset = quadVertex * dynamicSize;
